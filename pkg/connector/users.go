...
func (o *userBuilder) List(ctx context.Context, parentResourceID *v2.ResourceId, attrs rs.SyncOpAttrs) ([]*v2.Resource, *rs.SyncOpResults, error) {
	...
	return resources, &rs.SyncOpResults{NextPageToken: outToken, Annotations: annotation}, nil
}
...
func (o *userBuilder) Grants(ctx context.Context, resourceUser *v2.Resource, attrs rs.SyncOpAttrs) ([]*v2.Grant, *rs.SyncOpResults, error) {
